function [selected_data_ind, data_sorted, err, err_norm, sign_cell] = func_select_feature_oversample_from_center(data, spacing)
...
data_sorted = data(tmp,:); % data_mean at the top and then ascending order
