function [subsampled_data, rejected_data]= undersample_sam(data, centers, vr_thrs, delta_thresh_mean, overlap_rem_thres_angle) %% vr_thrs is the threshol for each feature in the
%%feature space
