...
This package contains the GICaPS undersampling algorithm presented in the following
paper:
...
This source code includes many matlab functions and one main file (runUnderSample.m) 
